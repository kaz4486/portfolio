    ...
    <div className='w-full'>
      <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='pb-4'>Bulletin Board</h2>
          <h3> React JS / Redux / Express / MongoDB / Bootstrap </h3>
        </div>
      </div>
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        <div className='col-span-4'>
          ...
          <h2>Overview</h2>
          <p className='py-2'>
            CRUD Application written in React + Redux. Minimalistic design, but
            user can signup and signin, create advertisement (and upload
